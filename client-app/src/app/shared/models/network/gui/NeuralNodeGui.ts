...
export class NeuralNodeGui {
  ...
  public constructor(id: number, status: Status, layer: LayerGui) {
    this._id = id;
    this._layer = layer;
    this._status = status;
  ...
  public draw(context: CanvasRenderingContext2D): void {
    ...
    context.beginPath();
    context.arc(this.pos.x, this.pos.y, NeuralNodeGui.RADIUS, 0, 2 * Math.PI, false);
    context.fillStyle = 'rgba(46, 49, 49, 1)';
    context.fill();
    context.closePath();

    context.beginPath();
    context.arc(this.pos.x, this.pos.y, NeuralNodeGui.RADIUS * 0.4, 0, 2 * Math.PI, false);
  ...
  public drawText(context: CanvasRenderingContext2D): void {
    ...
    context.fillStyle = 'rgba(46, 49, 49, 1)';
    context.fillText('' + this.id, this.pos.x + NeuralNodeGui.RADIUS * 1.1, this.pos.y);
    context.closePath();
  }

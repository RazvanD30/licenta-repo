...
export class NetworkSpecialRoutineComponent {
  ...
  operations = [
    {name: 'Ignore node', value: SpecialRoutineOperation.IGNORE_NODE},
    ...
    {name: 'Add to watchlist', value: SpecialRoutineOperation.ADD_TO_WATCHLIST, paramDesc: 'Tag associated to node'}
  ];

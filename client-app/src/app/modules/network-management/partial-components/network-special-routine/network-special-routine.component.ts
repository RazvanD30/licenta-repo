...
export class NetworkSpecialRoutineComponent {
  ...
  operations = [
    {name: 'Ignore offlineNode', value: SpecialRoutineOperation.IGNORE_NODE},
    {name: 'Decrease output weights', value: SpecialRoutineOperation.DECREASE_OUTPUT_WEIGHTS, paramDesc: 'The relative amount to subtract'},
    {name: 'Decrease input weights', value: SpecialRoutineOperation.DECREASE_INPUT_WEIGHTS, paramDesc: 'The relative amount to subtract'},
    {name: 'Increase output weights', value: SpecialRoutineOperation.INCREASE_OUTPUT_WEIGHTS, paramDesc: 'The relative amount to add'},
    {name: 'Increase input weights', value: SpecialRoutineOperation.INCREASE_INPUT_WEIGHTS, paramDesc: 'The relative amount to add'},
    ...
    {name: 'Add to watchlist', value: SpecialRoutineOperation.ADD_TO_WATCHLIST, paramDesc: 'Tag associated to offlineNode'}
  ];
